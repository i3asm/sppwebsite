...
@section('content')
              ...
              <div class="form-contents">
                ...
                @foreach($persons as $person)
                  @if ($year == $person->year)
                    ...
                    <form class="rtl" method="POST" action="{{route('home.update',['id'=>$person->id])}}">
                      @csrf
                      @method('PUT')
                      <label class="rtl">السنة:
                        <input type="text" class="form-control" name="year" min="1350" max="2050" step="1"
                               value="{{$person->year}}">
                      </label>
                      ...
                      <a href="{{route('home.delete',[$person->id])}}" class="btn btn-danger"
                         role="button">حذف</a>
                    </form>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-9">
        <div class="card">
          <div class="card-header rtl">إضافة حساب
            <div class="bg-warning">
              <h2 class="text-danger rtl">
                إضافة حسابات هي على مسؤليتك الشخصية.
              </h2>
